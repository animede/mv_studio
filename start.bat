...
if not defined SIMPLE_VIDEO_PORT set "SIMPLE_VIDEO_PORT=8091"
...
echo   -P, --port PORT                 Bind port (default: SIMPLE_VIDEO_PORT or 8091)
...
echo.
echo Examples:
echo   start.bat --host 0.0.0.0 --port 8091
